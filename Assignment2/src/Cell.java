...
public class Cell {
	...
	public Cell(int row, int col) {
		...
		// TODO: Initialise the variables row, col //COMPLETED
		this.row = row;
		this.col = col;
		// NOW DO FOR THE COLUMN
		
		
		//TODO: call the method that sets the cell content to EMPTY //COMPLETED
		clear();
	...
	public void clear() {
		...
		// TODO: Set the value of content to Empty (Remember this is an enum) //COMPLETED
		content = Player.Empty;  //JUST MAKE THE CELL EMPTY. SEE THE ENUM AND ALLOCATE THE EMPTY ONE TO THIS
						//VARIABLE
